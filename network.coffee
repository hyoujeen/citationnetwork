...
$ ->
  ...
  $("#song_select").on "change", (e) ->
    songFile = $(this).val()
    d3.json "https://s3-us-west-1.amazonaws.com/fd-network-viz-files/data/#{songFile}", (json) ->
  ...
  d3.json "https://s3-us-west-1.amazonaws.com/fd-network-viz-files/data/call_me_al.json", (json) ->
    myNetwork("#vis", json)
